...
def get_miss_dataset():
    ...
    rndz = ConnectRandomizer(parent_graph_dir='../gdf_Z.yml', child_graph_dir='gdf_R.yml', guideline_dir='guideline_1.yml',
...
with open('MAR_same_experiment_as_paper.json', 'w') as f:
    json.dump(results, f)